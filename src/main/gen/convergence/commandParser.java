...
public class commandParser extends Parser {
    ...
    public static class CommandContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterCommand(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitCommand(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof commandVisitor)
                return ((commandVisitor<? extends T>) visitor).visitCommand(this);
            else
    ...
    public static class ArgumentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterArgument(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitArgument(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof commandVisitor)
                return ((commandVisitor<? extends T>) visitor).visitArgument(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class NonQuoteArgumentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterNonQuoteArgument(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitNonQuoteArgument(this);
        }
    ...
    public static class QuoteArgumentContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterQuoteArgument(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitQuoteArgument(this);
        }
    ...
    public static class NotQuoteContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterNotQuote(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitNotQuote(this);
        }

        @Override
        public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
            if (visitor instanceof commandVisitor)
                return ((commandVisitor<? extends T>) visitor).visitNotQuote(this);
            else
                return visitor.visitChildren(this);
        }
    }
    ...
    public static class CommandNameContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).enterCommandName(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof commandListener)
                ((commandListener) listener).exitCommandName(this);
        }
