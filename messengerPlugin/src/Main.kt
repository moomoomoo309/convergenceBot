...
object MessengerInterface: BaseInterface, IFormatting, INickname, IImages, IMention, IMessageHistory, IUserAvailability, IStickers {
    ...
    override fun getMessages(chat: Chat, since: OffsetDateTime?, until: OffsetDateTime?): List<OptionalFunctionality.IMessageHistory.MessageHistory> = TODO()
    override fun getUserMessages(chat: Chat, user: User, since: OffsetDateTime?, until: OffsetDateTime?): List<OptionalFunctionality.IMessageHistory.MessageHistory> = TODO()
